...
func TestClient_SearchPosts(t *testing.T) {
	...
	p0 := result.Posts[0]
	t.Log(fmt.Sprint(n, p0.ID, n, p0.CreationDate, n, p0.Score, n, p0.Width, n,
...
func TestClient_SearchTags(t *testing.T) {
	...
	t0 := result.Tags[0]
	t.Log(fmt.Sprint(n, t0.ID, n, t0.Name, n, t0.Type, n, t0.Ambiguous, n, t0.Count))
}
...
func TestClient_SearchUsers(t *testing.T) {
	...
	u0 := result.Users[0]
	t.Log(fmt.Sprint(n, u0.ID, n, u0.Name, n, u0.Active))
}
...
func TestClient_SearchComments(t *testing.T) {
	...
	t.Log(fmt.Sprint(n, c0.ID, n, c0.PostID, n, c0.CreationDate, n, c0.Creator, n, c0.CreatorID))
}
